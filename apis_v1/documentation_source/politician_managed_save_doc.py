# apis_v1/documentation_source/politician_managed_save_doc.py
# Brought to you by We Vote. Be good.
# -*- coding: UTF-8 -*-


def politician_managed_save_doc_template_values(url_root):
    """
    ...
    api_response = '{\n' \
                   ...
                   ' (SAME RESPONSES as politicianManagedRetrieve)' \
                   '}'

    template_values = {
        'api_name': 'politicianManagedSave',
        'api_slug': 'politicianManagedSave',
        'api_introduction':
            "",
        'try_now_link': 'apis_v1:politicianManagedSaveView',
