...
urlpatterns = [
    ...
    re_path(r'^(?P<politician_we_vote_id>wv[\w]{2}pol[\w]+)/match_politician_to_organization$',
            views_admin.match_politician_to_organization_view, name='match_politician_to_organization'),
    ...
    re_path(r'^update_ultimate_election_date_from_candidates/',
            views_admin.update_politician_ultimate_election_date_from_candidates_view,
            name='update_ultimate_election_date_from_candidates'),
