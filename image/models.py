...
CAMPAIGNX_PHOTO_IMAGE_NAME = "campaignx_photo_image"
CTCL_PROFILE_IMAGE_NAME = "ctcl_profile_image"
...
VOTE_USA_PROFILE_IMAGE_NAME = "vote_usa_profile_image"
...
class WeVoteImage(models.Model):
    ...
    kind_of_image_voter_uploaded_profile = models.BooleanField(verbose_name="image was uploaded", default=False)
...
class WeVoteImageManager(models.Manager):
    ...
    def create_we_vote_image(
        ...
        try:
            ...
            success = False
            status += "WE_VOTE_IMAGE_NOT_CREATED: " + str(e) + " "
    ...
    @staticmethod
    def delete_we_vote_image(we_vote_image):
        """
    ...
    @staticmethod
    def delete_image_from_aws(we_vote_image_file_location):
        """
    ...
    @staticmethod
    def save_we_vote_image_facebook_info(
            we_vote_image,
            facebook_user_id,
            image_width,
            image_height,
            facebook_image_url_https,
            same_day_image_version,
    ...
    @staticmethod
    def save_we_vote_image_issue_info(
            we_vote_image,
            image_width,
            image_height,
            issue_image_url_https,
            same_day_image_version,
            image_url_valid=False):
        """
    ...
    @staticmethod
    def save_we_vote_image_maplight_info(
            we_vote_image,
            maplight_id,
            image_width,
            image_height,
            maplight_image_url_https,
            same_day_image_version,
    ...
    @staticmethod
    def save_we_vote_image_vote_smart_info(
            we_vote_image,
            vote_smart_id,
            image_width,
            image_height,
    ...
    @staticmethod
    def save_we_vote_image_vote_usa_info(
            we_vote_image=None,
            image_width='',
            image_height='',
            image_url_https='',
        ...
        try:
            ...
            we_vote_image.source_image_still_valid = image_url_valid
            we_vote_image.same_day_image_version = same_day_image_version
            we_vote_image.photo_url_from_vote_usa = image_url_https
            we_vote_image.save()
            success = True
            status = "SAVED_WE_VOTE_IMAGE_VOTE_USA_PROFILE_INFO "
        except Exception as e:
            status = "UNABLE_TO_SAVE_WE_VOTE_IMAGE_VOTE_USA_PROFILE_INFO: " + str(e) + ' '
            success = False
            handle_record_not_saved_exception(e, logger=logger, exception_message_optional=status)
    ...
    @staticmethod
    def save_we_vote_image_voter_uploaded_info(
            we_vote_image=None,
            image_width='',
            image_height='',
            image_url_https='',
        ...
        try:
            ...
            we_vote_image.source_image_still_valid = image_url_valid
            we_vote_image.same_day_image_version = same_day_image_version
            we_vote_image.voter_uploaded_profile_image_url_https = image_url_https
            we_vote_image.save()
            success = True
            status = "SAVED_WE_VOTE_IMAGE_VOTER_UPLOADED_INFO "
        except Exception as e:
            status = "UNABLE_TO_SAVE_WE_VOTE_IMAGE_VOTER_UPLOADED_INFO: " + str(e) + ' '
            success = False
            handle_record_not_saved_exception(e, logger=logger, exception_message_optional=status)
    ...
    @staticmethod
    def save_we_vote_image_ballotpedia_info(
            we_vote_image,
            image_width,
            image_height,
            ballotpedia_profile_image_url,
            same_day_image_version,
            kind_of_image_ballotpedia_profile,
            image_url_valid=False):
        """
        Save Ballotpedia information to WeVoteImage
        :param we_vote_image:
        :param image_width:
        :param image_height:
        ...
        try:
            ...
            status = "UNABLE_TO_SAVE_WE_VOTE_IMAGE_BALLOTPEDIA_INFO: " + str(e) + ' '
            success = False
            handle_record_not_saved_exception(e, logger=logger, exception_message_optional=status)
    ...
    @staticmethod
    def save_we_vote_image_campaignx_info(
            we_vote_image=None,
            image_width='',
            image_height='',
            image_url_https='',
    ...
    @staticmethod
    def save_we_vote_image_ctcl_info(
            we_vote_image=None,
            image_width='',
            image_height='',
            image_url_https='',
        ...
        try:
            ...
            we_vote_image.source_image_still_valid = image_url_valid
            we_vote_image.same_day_image_version = same_day_image_version
            we_vote_image.photo_url_from_ctcl = image_url_https
            we_vote_image.save()
            success = True
            status = "SAVED_WE_VOTE_IMAGE_CTCL_PROFILE_INFO "
        except Exception as e:
            status = "UNABLE_TO_SAVE_WE_VOTE_IMAGE_CTCL_PROFILE_INFO: " + str(e) + ' '
            success = False
            handle_record_not_saved_exception(e, logger=logger, exception_message_optional=status)
    ...
    @staticmethod
    def save_we_vote_image_linkedin_info(
            we_vote_image,
            image_width,
            image_height,
            ...
            image_url_valid=False):
        """
        Save LinkedIn information to WeVoteImage
        :param we_vote_image:
        :param image_width:
        :param image_height:
    ...
    @staticmethod
    def save_we_vote_image_wikipedia_info(
            we_vote_image,
            image_width,
            image_height,
            wikipedia_profile_image_url,
            same_day_image_version,
    ...
    @staticmethod
    def save_we_vote_image_other_source_info(
            we_vote_image,
            image_width,
            image_height,
            other_source,
            other_source_image_url,
            same_day_image_version,
    ...
    @staticmethod
    def save_we_vote_image_twitter_info(
            we_vote_image,
            twitter_id,
            image_width,
            image_height,
    ...
    @staticmethod
    def save_we_vote_image_aws_info(
            we_vote_image,
            we_vote_image_url='',
    ...
    @staticmethod
    def set_active_version_false_for_other_images(
            campaignx_we_vote_id=None,
            candidate_we_vote_id=None,
        ...
        try:
            ...
            if kind_of_image_ctcl_profile:
                we_vote_image_list = we_vote_image_list.exclude(photo_url_from_ctcl=image_url_https)
            ...
            if kind_of_image_vote_usa_profile:
                we_vote_image_list = we_vote_image_list.exclude(photo_url_from_vote_usa=image_url_https)
            if kind_of_image_voter_uploaded_profile:
                we_vote_image_list = we_vote_image_list.exclude(voter_uploaded_profile_image_url_https=image_url_https)
            if kind_of_image_wikipedia_profile:
            ...
            status += "UNABLE_TO_SET_ACTIVE_VERSION_FALSE_FOR_OTHER_IMAGES: " + str(e) + " "
            success = False
            handle_exception(e, logger=logger, exception_message=status)
    ...
    @staticmethod
    def retrieve_we_vote_image_from_id(we_vote_image_id):
        """
    ...
    @staticmethod
    def retrieve_latest_facebook_images_for_voter(voter_we_vote_id, facebook_profile_image_url_https):
        status = ''
        success = False
    ...
    @staticmethod
    def retrieve_we_vote_image_list_from_we_vote_id(
            voter_we_vote_id=None,
            candidate_we_vote_id=None,
            issue_we_vote_id=None,
            organization_we_vote_id=None,
    ...
    @staticmethod
    def retrieve_we_vote_image_list_from_google_civic_election_id(google_civic_election_id):
        """
    ...
    @staticmethod
    def twitter_profile_image_url_https_original(twitter_profile_image_url_https):
    ...
    def retrieve_we_vote_image_from_url(
            self,
    ...
    @staticmethod
    def retrieve_we_vote_image_from_facebook_url(we_vote_image_url):
        """
    ...
    @staticmethod
    def retrieve_we_vote_image_list_from_url(
            ballotpedia_profile_image_url=None,
            campaignx_photo_url_https=None,
            campaignx_we_vote_id=None,
            candidate_we_vote_id=None,
        ...
        try:
            ...
            status += " FAILED_TO RETRIEVE_CACHED_WE_VOTE_IMAGE_LIST_FROM_URL: " + str(e) + " "
            success = False
            we_vote_image_list_found = False
            handle_exception(e, logger=logger, exception_message=status)
    ...
    def retrieve_recent_cached_we_vote_image(
        ...
        try:
            ...
            status += " FAILED_TO RETRIEVE_RECENT_CACHED_WE_VOTE_IMAGE: " + str(e) + " "
            success = False
            we_vote_image_found = False
            handle_exception(e, logger=logger, exception_message=status)
    ...
    @staticmethod
    def retrieve_todays_cached_we_vote_image_list(
            campaignx_we_vote_id=None,
            candidate_we_vote_id=None,
            issue_we_vote_id=None,
            kind_of_image_ballotpedia_profile=False,
        ...
        try:
            ...
            status += " FAILED_TO RETRIEVE_TODAYS_CACHED_WE_VOTE_IMAGE_LIST: " + str(e) + " "
            success = False
            we_vote_image_list_found = False
            handle_exception(e, logger=logger, exception_message=status)
    ...
    @staticmethod
    def resize_we_vote_master_image(
            image_local_path='',
            image_width=0,
            image_height=0,
            image_type='',
    ...
    @staticmethod
    def store_python_image_locally(python_image_library_image, image_local_path):
        """
        Save image locally at /tmp/ folder
    ...
    @staticmethod
    def store_image_to_aws(we_vote_image_file_name='', we_vote_image_file_location='', image_format=''):
        """
        Upload image to aws
    ...
    @staticmethod
    def store_image_file_to_aws(image_file, we_vote_image_file_location):
        """
    ...
    @staticmethod
    def retrieve_image_from_aws(we_vote_image_file_location):
        """
