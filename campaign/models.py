...
class CampaignX(models.Model):
    ...
    #  TODO: Clarify this is the cached data, with the master stored in the Politician table.
    ...
    linked_politician_we_vote_id = models.CharField(max_length=255, null=True, db_index=True)
    ...
    # Every politician has one default CampaignX entry that follows them over time. We store that politician
    #  identifier in the linked_politician_we_vote_id field.
