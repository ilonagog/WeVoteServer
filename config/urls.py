...
urlpatterns = [
    ...
    re_path(r'^googlebot_site_map/',
            include(('googlebot_site_map.urls', 'googlebot_site_map'), namespace="googlebot_site_map")),
    ...
    re_path(r'^representative_list/',
            include(('representative.urls', 'representative_list'), namespace="representative_list")),
    re_path(r'^representative/', include(('representative.urls', 'representative'), namespace="representative")),
    re_path(r'^electoral_district/',
            include(('electoral_district.urls', 'electoral_district'), namespace="electoral_district")),
    re_path(r'^follow/', include(('follow.urls', 'follow'), namespace="follow")),
    re_path(r'^friend/', include(('friend.urls', 'friend'), namespace="friend")),
    re_path(r'^google_custom_search/',
    ...
    re_path(r'^import_export_bigquery/',
            include(('import_export_bigquery.urls', 'import_export_bigquery'),
                    namespace="import_export_bigquery")),
    re_path(r'^import_export_ctcl/',
            include(('import_export_ctcl.urls', 'import_export_ctcl'), namespace="import_export_ctcl")),
    re_path(r'^import_export_facebook/',
    ...
    re_path(r'^import_export_openreplay/',
            include(('import_export_openreplay.urls', 'import_export_openreplay'),
                    namespace="import_export_openreplay")),
    re_path(r'^import_export_twitter/',
            include(('import_export_twitter.urls', 'import_export_twitter'), namespace="import_export_twitter")),
    re_path(r'^import_export_vote_smart/',
            include(('import_export_vote_smart.urls', 'import_export_vote_smart'),
                    namespace="import_export_vote_smart")),
    re_path(r'^import_export_wikipedia/',
            include(('import_export_wikipedia.urls', 'import_export_wikipedia'),
    ...
    re_path(r'^organization_plans/',
            include(('donate.urls', 'organization_plans'), namespace="organization_plans")),
    ...
    re_path(r'^retrieve_tables/',
            include(('retrieve_tables.urls', 'retrieve_tables'), namespace="retrieve_tables")),
    ...
    re_path(r'^sod/',
            include(('support_oppose_deciding.urls', 'support_oppose_deciding'),
