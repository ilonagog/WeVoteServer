...
urlpatterns = [
    ...
    re_path(r'^duplicates_list/$', views_admin.organization_duplicates_list_view, name='duplicates_list'),
    re_path(r'^not_duplicates/$', views_admin.organizations_not_duplicates_view, name='not_duplicates'),
    ...
    re_path(r'^delete_all_duplicates/$',
            views_admin.organization_delete_all_duplicates_view, name='delete_all_duplicates'),
    ...
    re_path(r'^edit_listed_campaigns_process/$',
            views_admin.organization_edit_listed_campaigns_process_view,
            name='organization_edit_listed_campaigns_process'),
    re_path(r'^edit_process/$', views_admin.organization_edit_process_view, name='organization_edit_process'),
    re_path(r'^(?P<organization_we_vote_id>wv[\w]{2}org[\w]+)/edit_team_members/$',
            views_admin.edit_team_members_view, name='edit_team_members', ),
    re_path(r'^edit_team_members_process/$',
            views_admin.edit_team_members_process_view, name='edit_team_members_process'),
    re_path(r'^find_and_merge_duplicate_organizations/$',
            views_admin.find_and_merge_duplicate_organizations_view, name='find_and_merge_duplicate_organizations'),
    re_path(r'^import/$',
